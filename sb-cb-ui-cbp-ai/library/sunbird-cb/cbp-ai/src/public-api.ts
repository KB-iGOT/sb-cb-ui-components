...
export * from './lib/modules/upload-document-page/upload-dialog/upload-dialog.component'
export * from './lib/components/delete-role-mapping-popup/delete-role-mapping-popup.component'
export * from './lib/components/suggest-more-courses/suggest-more-courses.component'
export * from './lib/components/add-designation/add-designation.component'
